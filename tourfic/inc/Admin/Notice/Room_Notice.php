		...
		if ( get_option( $this->notice_id ) < 1 ) {
            ?>
                <div class="tf-critical-update-notice notice notice-info is-dismissible">
                    ...
                    <p><?php echo wp_kses_post( __(' If you experience any inconvenience after updating to <b>Tourfic version 2.16.6 </b>, please don\'t hesitate to reach out to our <a href="https://portal.themefic.com/support/" target="_blank"><b>Support Team</b></a>. We\'re  here to assist you with any inconvenience.', "tourfic")); ?></p>
                </div>
